...
agent_test_id = 5
start = starts[agent_test_id]
goal = goals[agent_test_id]
goal_radius = 0.3

agent = get_quadcopter_agent(agent_test_id)
...
# s = 3519
print("Seed: ", s)
rrt = get_rrt_planner(start, goal, goal_radius, agent, env)
rrt.rng_seed = s
rrt.rng = np.random.default_rng(rrt.rng_seed)
...
#==================
# Kino TI EB RRT Tests - with VxyzTree (circular kd tree)
#==================
...
# s = 4629
print("Seed: ", s)
kino_eb_rrt = get_kino_TI_eb_rrt_planner(start, goal, goal_radius, agent, env)
kino_eb_rrt.rng_seed = s
kino_eb_rrt.rng = np.random.default_rng(kino_eb_rrt.rng_seed)
kino_eb_rrt.plan_path()
node_ids, states, actions, timesteps = kino_eb_rrt.get_path()
kino_eb_rrt.path_cost
...
#==================
# Kino TI EB RRT Tests - with VxyzGridTree (grid kd tree)
#==================
...
s = 912
print("Seed: ", s)
kino_eb_rrt_grid = get_kino_TI_eb_rrt_planner_grid_quadcopter6d(start, goal, goal_radius, agent, env)
kino_eb_rrt_grid.rng_seed = s
kino_eb_rrt_grid.rng = np.random.default_rng(kino_eb_rrt_grid.rng_seed)
kino_eb_rrt_grid.debug_flag = True
kino_eb_rrt_grid.plan_path()
node_ids, states, actions, timesteps = kino_eb_rrt_grid.get_path()
kino_eb_rrt_grid.path_cost

...
v.print_rrt('media/kino_TI_eb_rrt_unicycle.png')
...
plot_edge_ids = kd_tree_TI_eb_unicycle.radius_query(1.0, 0.1)
kino_TI_eb_unicycle.plot_edges_by_ids(plot_edge_ids)

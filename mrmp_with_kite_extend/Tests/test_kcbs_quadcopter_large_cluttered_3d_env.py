...
# obstacles = []
env = CuboidEnvironment(length=14.0, breadth=14.0, height=10.0, obs=obstacles, obs_buffers=False)
...
starts = [
    ...
    np.array((2.5, 6.5, 0.5, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((11.5, 10.5, 1.0, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((5.0, 2.0, 0.6, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((10.0, 5.0, 1.5, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((7.0, 10.0, 0.8, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((2.0, 10.0, 1.0, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((12.0, 5.0, 2.0, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((9.0, 1.5, 0.7, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((3.5, 9.0, 1.2, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((10.5, 12.0, 1.5, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((5.5, 5.5, 0.9, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((12.5, 7.2, 2.5, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((2.0, 3.0, 1.5, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((8.5, 10.0, 2.0, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((4.5, 7.0, 1.0, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((7.5, 12.0, 2.5, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((11.0, 9.0, 0.6, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((1.5, 3.0, 5.0, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((9.5, 2.5, 1.8, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((6.5, 2.0, 0.7, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((3.0, 13.0, 1.5, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((10.5, 8.5, 1.2, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((5.5, 11.5, 2.0, 0.0, 0.0, 0.0), dtype=np.float64),
    np.array((9.0, 6.0, 0.8, 0.0, 0.0, 0.0), dtype=np.float64),
]
goals = [
    ...
    np.array((11.0, 2.0, 2.5), dtype=np.float64),
    np.array((2.25, 2.25, 1.25), dtype=np.float64),
    np.array((12.5, 11.5, 8.0), dtype=np.float64),
    np.array((2.75, 7.5, 4.0), dtype=np.float64),
    np.array((2.0, 1.5, 3.0), dtype=np.float64),
    np.array((10.0, 1.0, 5.5), dtype=np.float64),
    np.array((1.5, 12.0, 7.0), dtype=np.float64),
    np.array((12.0, 6.5, 3.5), dtype=np.float64),
    np.array((8.5, 1.5, 6.5), dtype=np.float64),
    np.array((3.0, 12.75, 2.5), dtype=np.float64),
    np.array((12.75, 7.0, 5.0), dtype=np.float64),
    np.array((5.0, 1.5, 7.0), dtype=np.float64),
    np.array((12.0, 12.5, 5.0), dtype=np.float64),
    np.array((5.0, 1.25, 8.75), dtype=np.float64),
    np.array((6.5, 12.0, 3.5), dtype=np.float64),
    np.array((12.5, 4.5, 1.5), dtype=np.float64),
    np.array((2.8, 2.5, 7.5), dtype=np.float64),
    np.array((10.0, 11.0, 2.0), dtype=np.float64),
    np.array((1.0, 9.5, 6.0), dtype=np.float64),
    np.array((13.0, 5.0, 8.5), dtype=np.float64),
    np.array((3.0, 10.0, 1.5), dtype=np.float64),
    np.array((11.5, 1.8, 4.0), dtype=np.float64),
    np.array((7.5, 3.5, 9.0), dtype=np.float64),
    np.array((2.5, 8.0, 2.5), dtype=np.float64),
]
goal_radius = 0.3
...
# seeds = [111]
# seeds = np.random.randint(0, 1000, size=15)
# seeds = [964, 658, 960, 108, 823, 356, 516, 709, 707, 357, 532, 118, 649,
    #    157, 939]
costs = []
time_array = []

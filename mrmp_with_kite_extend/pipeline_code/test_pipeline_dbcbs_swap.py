...
class TestPipelineDbaSwap(TestPipeline):
    ...
    def __init__(self, test_classes, agent_builders, test_rounds=10, num_agents=8, master_seed=42):
        ...
        names = 'swap2_unicycle_sphere.yaml'
        ...
        super().__init__(test_classes, agent_builders, test_rounds, num_agents, env_width=5, env_bredth=5, master_seed=master_seed)
    ...
    def get_env_parms(self, seed): 
        ...
        MultiRRTPrinter.print_rrt_env('checkswap_' + str(self.num_agents) + '_' + str(self.env_counter) + '.png',
...
for num_agents in [2]:
    ...
    tp.run()
    tp.print_stats(filename="paper_results/dbcbs_swap_gr02", plots=True)

...
class EdgeBundleRRTAnimator(EdgeBundleType2RRT):
    ...
    def sort_edges(self, closest_tree_point, random_point, final_states,
                   distance_array):
        """
        ...
        for i in range(len(final_states)):
            potential_new_point = self.translate(closest_tree_point,final_states[i])
        ...
        potential_new_point = self.translate(closest_tree_point,final_states[sorted_indices[0]])
        ...
        print(f"Best Edge from the Bundle: {final_states[sorted_indices[0]]}")
...
#Unicycle Edge Bundle RRT Example

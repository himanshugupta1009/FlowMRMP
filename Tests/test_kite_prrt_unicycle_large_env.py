...
edge_bundle_file = 'edge_bundles_unclamped/eb_unicycle_dbCBS_kinodynamic_TI_edges_100000.npz'
num_edges = 30000
...
for agent_id in range(num_agents):
    ...
    data = np.load(edge_bundle_file)
    edge_bundle = EdgeBundle(
        data,
        fix_num_edges=num_edges,
        use_all_edges=False,
        rng_seed=42 + agent_id,
    )
...
print("Prioritized Kino-TI EB RRT seed:", rng_seed)
...
print("Edge bundle:", edge_bundle_file)
print("Edges per agent:", num_edges)
